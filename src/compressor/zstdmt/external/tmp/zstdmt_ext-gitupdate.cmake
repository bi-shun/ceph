...
if("${show_ref_output}" MATCHES "refs/remotes/v1.2.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v1.2.0")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/facebook/zstd.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/samuel/workspace/ceph/src/zstd2/zstd/build/cmake/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/samuel/workspace/ceph/src/zstd2/zstd/build/cmake/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
